    ...
    (e.prototype = {
        ...
        init: function () {
            ...
            return (
                ...
                "default" !== this.config.locale &&
                    (b.localize_i18n = this.config.locale),
                this.getSectionsCount() < 2 &&
                    a(this.config.btnRemove, this.$elem).hide(),
        ...
        cloneSection: function () {
            if (
                ...
                return !1;
            var b = a(this.config.section, this.$elem)
                .last()
                .clone()
                .attr("style", "")
                .attr("id", "")
            ...
            a('input[type!="radio"],textarea', b).each(function () {
                ...
                b.find('input[type="radio"]').each(function () {
                    ...
                    a(this).attr(
                        "name",
                        b.replace(/([0-9]+)/g, 1 * b.match(/([0-9]+)/g) + 1)
                    );
                }),
                a("input[type=radio]", b).attr("checked", !1),
                a("img.reset-image-src", b).each(function () {
                    a(this).attr("src", "");
                }),
                this.$elem.append(b),
                a(this.config.btnRemove, this.$elem).show();
        },

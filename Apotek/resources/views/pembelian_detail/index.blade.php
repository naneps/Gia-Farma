                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col-lg-8">
                                        <div style="color:white" class="tampil-bayar bg-primary"></div>
                                    ...
                                    <div class="col-lg-4">
                                        <form action="{{ route('pembelian.store') }}" class="form-pembelian"
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="totalrp" ontrol-label">Total</label>
                                                    <input type="text" id="totalrp" class="form-control" readonly>
                                                </div>
                                            </div>
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="diskon" ontrol-label">Diskon</label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    <label for="bayar" ontrol-label">Bayar</label>
